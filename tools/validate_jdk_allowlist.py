...
MUST_THROW = [
    ...
    ("java/io/StringReader","<init>",      'new java.io.StringReader(null)', "(Ljava/lang/String;)V"),
    ("java/lang/String",    "<init>",      'new String((char[]) null)', "([C)V"),
    ("java/lang/String",    "<init>",      'new String(new char[2], 0, 5)', "([CII)V"),
    ("java/lang/String",    "regionMatches", '"x".regionMatches(0, (String) null, 0, 1)', "(ILjava/lang/String;II)Z"),
    ("java/lang/String",    "regionMatches", '"x".regionMatches(true, 0, (String) null, 0, 1)', "(ZILjava/lang/String;II)Z"),
...
MUST_NOT_THROW = [
    ...
    ("java/lang/Character","isJavaIdentifierStart", 'Character.isJavaIdentifierStart((char) 0xFFFF)', "(C)Z"),
    ("java/lang/Character","isJavaIdentifierPart", 'Character.isJavaIdentifierPart((char) 0)', "(C)Z"),
    ("java/lang/StringBuilder","ensureCapacity", 'new StringBuilder().ensureCapacity(Integer.MIN_VALUE)', "(I)V"),
