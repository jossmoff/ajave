...
fn is_concrete_math_call(owner: &str, name: &str) -> bool {
    match owner {
...
fn eval_math_call(
    ...
    // For static methods, args are just the parameters.
    ...
    match owner {
        "java/lang/Math" | "java/lang/StrictMath" => {
            // All Math methods here are static with int/long params
            match name {
                "abs" => match get_val(0) {
        ...
        "java/lang/Integer" => match name {
            ...
            "parseInt" => Value::Unknown, // can't parse string to int in concrete engine easily
            _ => Value::Unknown,
        },
        ...
        "java/lang/Double" | "java/lang/Float" => match name {
            "compare" | "hashCode" | "isNaN" | "isInfinite" | "isFinite" => Value::Unknown, // float ops - can't model in concrete int engine
            _ => Value::Unknown,
        },
        _ => Value::Unknown,
    }
